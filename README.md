...
| /api/movies/createMovie | `POST` | {'title':'foo', 'category':'bar', 'country':'Turkey', year:1990, director:"id", imdb_score: 9.7 } | Create a new movie. |
...
| /api/directors/createDirector | `POST` | { name: 'foo', surname:'bar', bio:'lorem ipsum' } | Create a new director. |
